...
namespace HrDbProject.Views
{
    ...
    {
        private readonly HrDbProjectContext _context;

        public EmployeesController(HrDbProjectContext context)
        {
            _context = context;
        }
        ...
        {
            var hrDbProjectContext = _context.Employees.Include(e => e.Department);
            return View(await hrDbProjectContext.ToListAsync());
        }
